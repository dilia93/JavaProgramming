...
public class RelationalOperators {
    ...
    public static void main(String[] args) {
        ...
        boolean isEligibleForLoan = creditScore >= 720; //if the credit score is 720 or greater, then ts eligible for loan
        ...
        boolean result11 = 110 != 200.5; //true
        System.out.println("result11 = " + result11);

        boolean result12 = "Java" != "Break"; //trie
